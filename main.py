...
async def serve_login(request: Request):
    ...
    return templates.TemplateResponse("login.html", {"request": request, "flash_msg": flash_msg})

@app.get("/register")
async def serve_register(request: Request):
    flash_msg = request.session.pop("flash_msg", None)
    return templates.TemplateResponse("register.html", {"request": request, "flash_msg": flash_msg})
